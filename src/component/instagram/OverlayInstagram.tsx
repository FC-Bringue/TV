...
const Overlaytwitter = () => {
    ...
    return (<section id="twitter-embedded" style={{display:"flex",flexWrap:"wrap", height:"65vh", overflowY:"auto", margin:"auto", width:"40%", justifyContent:"space-between", background:"white", borderRadius:"25px", padding:"0.5em"}}>
